...
export default function DriverDashboard({
    ...
    return (
        <MainLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="grid grid-cols-1 gap-y-3 p-2 md:p-10 lg:flex lg:flex-col">
                {/* Row 1: Welcome */}
                    ...
                    {loading ? (
                        ...
                        <Card
                            className={`mt-4 border-2 p-4 ${
                                trip.trip.status === 'Ongoing' ? 'border-yellow-500 text-yellow-500' : 'border-red-500 text-red-500'
                            }`}
                        >
                            <CardHeader>
                                <h3 className="text-lg font-semibold">{trip.trip.status === 'Ongoing' ? 'In transit' : 'Trip not yet started'}</h3>
                            </CardHeader>
                        ...
                        <div className="text-md flex h-55 items-center justify-center rounded-lg border border-gray-300 p-6 font-semibold text-black">
