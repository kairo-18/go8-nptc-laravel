                ...
                <div className="w-full">
                    {vehicles.length === 0 ? (
                        ...
                        vehicles.map((vehicle) => (
                            <Card key={vehicle.id} className="mb-6 p-6 shadow-md">
                                <CardHeader>
                                    {isEditing ? (
                                        <div className="space-y-2">
                                            ...
                                            />
                                            <Label>Model</Label>
                                            <Input name="Model" value={formData?.Model ?? vehicle.Model} onChange={handleChange} />
                                            <Label>Brand</Label>
                                            <Input name="Brand" value={formData?.Brand ?? vehicle.Brand} onChange={handleChange} />
                                        ...
                                        <>
                                            ...
                                            <p className="text-gray-500">
                                                Brand: {vehicle.Brand} | Seats: {vehicle.SeatNumber}
                                            </p>
                                        </>
                                    )}
                                </CardHeader>
                                    ...
                                    {isEditing && (
                                        <div className="grid grid-cols-2 gap-4">
                                            {[
                                                ...
                                                const existingFile = vehicle.media_files.find(
