...
import { Car, Clock, MapPinned, MapPinX, UserPlus } from 'lucide-react';
        ...
        <MainLayout breadcrumbs={breadcrumbs}>
            ...
            <motion.div {...headerVariants}>
                <h1 className="text-3xl font-bold tracking-tight md:text-4xl">
                    Welcome Back, <span className="text-primary">{operatorName}</span>!
                </h1>
                <p className="text-muted-foreground mt-2">Here's your operator dashboard overview</p>
            </motion.div>
            ...
            >
                ...
                <div className="space-y-4 lg:col-span-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <StatCard title="Active Drivers" value={activeDriversCount} icon={Car} trend="neutral" />
                        <StatCard title="Pending Registrations" value={pendingRegistrationsCount} icon={UserPlus} trend="down" />
                    </div>
                </div>
