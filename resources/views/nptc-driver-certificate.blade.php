...
<body>
    <div class="container">
        <div class="mid-content">
            ...
            <div class="details">
                <h1>NPTC Driver Certification</h1>
                <p class="certificate-content">This is to certify that</p>
                <h2>{{ $payload['name'] }}</h2>
                <p class="certificate-content">has successfully verified as NPTC Driver</p>
    ...
    @if(!app('request')->routeIs('download.pdf'))
        <div class="hidden-in-pdf">
            ...
            <a href="{{ route('download.pdf', ['certificate_type' => 'nptc-driver-certificate']) }}">Download PDF</a>
        </div>
    @endif
</body>
</html>
