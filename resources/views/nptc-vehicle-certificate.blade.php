...
<body>
    <div class="container">
        <div class="mid-content">
            ...
            <div class="details">
                <h1>NPTC Vehicle Certification</h1>
                <p class="certificate-content">This is to certify that</p>
                <h2>{{ $payload['name'] }}</h2>
                <p class="certificate-content">has successfully verified as NPTC Vehicle</p>
    ...
    @if(!app('request')->routeIs('download.pdf'))
        <div class="hidden-in-pdf">
            ...
            <a href="{{ route('download.pdf', ['certificate_type' => 'nptc-vehicle-certificate']) }}">Download PDF</a>
        </div>
    @endif
</body>
</html>
