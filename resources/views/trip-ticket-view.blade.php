...
@else
    <img src="/images/default-logo.png" alt="Default Logo" class="company-logo">
@endif
...
@endif
                ...
                <div class="contract-signatures">
                    <div class="signature-section">
                        <div>
                            ...
                            <p>Position</p>
                            <p>Valid Id No._______________</p>
                        </div>
                        <div>
                            <div class="signature-line"></div>
                            <p>Client</p>
                            <p>ID No. _____________________</p>
                        </div>
                    </div>
                </div>
                
                <div class="witness-section">
                    <p style="text-align: center;">Signed in the presence of:</p>
        ...
        <div class="download-btn">
            <a href="{{ env('APP_URL').'/trip-ticket/download/'.$trip->id }}">Download</a>
        </div>
