...
<body>
    <div class="container">
        <div class="mid-content">
            ...
            <div class="details">
                ...
                <h2>{{ $payload['name'] }}</h2>
                <p class="certificate-content">has successfully verified as NPTC Operator</p>
    ...
    @if(!app('request')->routeIs('download.pdf'))
        <div class="hidden-in-pdf">
            ...
            <a href="{{ route('download.pdf', ['certificate_type' => 'nptc-operator-certificate']) }}">Download PDF</a>
        </div>
    @endif
</body>
</html>
